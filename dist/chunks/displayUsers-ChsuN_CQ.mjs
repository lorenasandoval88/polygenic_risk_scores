import { fetch23andMeParticipants, get23Txt } from 'https://lorenasandoval88.github.io/personal_genomes_project_sdk/dist/sdk.mjs';
...
function renderParticipantsTable(list, targetId, title, key) {
	...
	const renderPage = () => {
		...
		const rowsHtml = pageItems.map((p, i) => {
			...
			const genoFilename = p.genotypes?.[0]?.filename ?? p.genotypes?.[0]?.download_url ?? p.downloadUrl ?? p.download_url;
...
computeV4V5Overlap();
//# sourceMappingURL=displayUsers-ChsuN_CQ.mjs.map
