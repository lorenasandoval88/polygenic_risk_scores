...
/**
 * Extract age and gender from a PGP profile's Google survey results.
...
function extractDemographics(profile) {
	const out = { age: null, gender: null };
...
function flattenCuratedRecord(rec) {
	...
	const { age, gender } = extractDemographics(rec.profile);
	return {
		id: rec.id,
...
function participantsToCsv(list) {
	const cols = [
		'id', 'name', 'age', 'gender', 'valid23File', 'version', 'build', 'sizeMB', 'filename',
...
//# sourceMappingURL=displayUsers-C5SYSZ0p.mjs.map
